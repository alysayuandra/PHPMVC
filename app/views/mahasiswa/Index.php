		...
		<div class="col-lg-6">
			...
			<ul class="list-group">
 			 ...
 			 <li class="list-group-item ">
 			 	...
 			 	<a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id']; ?> " class="badge badge-warning float-right  tampilModalUbah ml-2" data-toggle="modal" data-target="#formModal" data-id="<?= $mhs['id']; ?>">Ubah</a>
